...
The aim of this thesis is to demonstrate the viability of the digital back-end novel of a pixelated readout to be used in Time Projection Chambers (TPCs). 
...
\begin{tabular}{||c c c c c||}
 ...
 \hline
 $\nu_{e}$ & 0 & unknown & 1956 & Cowan-Reines experiment~\citep{first_neutrino_measurement} \\
 \hline
 $\nu_{\mu}$ & 0 & unknown & 1977 & Brookhaven National Lab~\citep{PhysRevLett.9.36} \\
 \hline
...
Despite the SMs many successes there is still much about the universe which remains unexplained.
...
These searches are interesting, albeit difficult, due to the rareness of such an event~\citep{DUNE_TDR_V1_Abi_2020, https://doi.org/10.48550/arxiv.1805.04163, Juno:2022103927}.
