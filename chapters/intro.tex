...
The SM itself dictates what the fundamental constiuents of matter and energy are.
...
The discussion of the renormalization of quantum-gravity is beyond the scope of the work presented here, and so we only mention that it has to be achieved.
...
These Particle accelerators generate extremely high energy ($\approx \mathcal{O}(10 TeV)$) protons which when collided can generate new compositie hadrons of any mass so that the total energy is conserved.
...
Unlike the quarks the leptonic particles do not have a color quantum number and therefore do not combine together to create compositive particles.
...
All particles which carry charge interfact with this force, therefore the neutrinos are the only particles within the quarks and leptons which do not interact at all with the electromagnetic force (this is why detecting them is so hard).
The full theoretical description of this force is governed by Quantum-Electrodynamics (QED).

The weak-nuclear force is goverened by particles exchanges of one of the three particles in the center: $W^{\pm}$ and $Z$.
...
The strong-nuclear force is goverened by the exchange of the gluon ($g$).
