...
The extensive comprehensive list of known particles as well as various cross-sections and lifetimes can be found from the bi-annually published Particle Data Group (PDG)~\citep{Workman:2022ynf}.
...
Since then, many large-scale experiments have been dedicated to measuring the three generations of neutrinos~\ref{
  SNO_2002_neutrino_PhysRevLett.89.011301,
