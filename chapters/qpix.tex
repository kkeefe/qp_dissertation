...
Previous work has been done to characterize how a Q-Pix based DUNE-FD would measure core collapse supernovae~\citep{qpix:shion}.
These studies involved particle Geant4-based(~\citep{geant4:AGOSTINELLI2003250}) simulations for low energy ($\simeq$ 10~\unit{MeV}) neutrino events from supernova.
...
Figure~\ref{fig:qpix_shion} highlights one result from this study which shows how a Q-Pix readout compares against traditional wire-readout for supernova trigger burst effeciencies. 
