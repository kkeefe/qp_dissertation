...
% This section provides a brief discussion about an adequate aggregator node.
...
% Then, we imagine the final multiplexing stage for an entire DUNE module as an array of SDNs, each of which constitute an array of DAQ nodes, where each DAQ node is a 2-D array of Q-Pix based ASICs.
