...
For this we use as an input source neutrino events from the Long-Baseline Neutrino Facillity(~\citep{dune_cdr_2016_arxiv}) and take the unoscillated flux of neutrinos which were used in~\citep{dune_2021_near_detector_cdr}.
