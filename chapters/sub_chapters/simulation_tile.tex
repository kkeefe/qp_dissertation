...
\begin{figure}[]
\centering
\includegraphics[width=0.7\textwidth]{images/simulation_process_method.pdf}
...
This procedure repeats until all nodes in the tile research designated time, which for the results presented here is 11~\unit{seconds}.
}
\end{figure}~\label{fig:simulation_process_procedure}

A transaction represents a 64-bit packet that is transfered between two nodes (Sect.~\ref{sec:digi_communications}).
