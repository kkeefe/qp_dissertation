...
Each 10-kT FD requires high precision in both time ($\lg \mu s$) and spatial resolution ($\approx$~1~\unit{mm}) for vertex reconstruction and particle identification (PID) of neutrino events.
